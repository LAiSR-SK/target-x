...
CIFARTestingFunction(anet, 0.0005, 'target-x_BatchTesting_AlexNet_0005_CIFAR.csv')
CIFARTestingFunction(anet, 0.0001, 'target-x_BatchTesting_AlexNet_0001_CIFAR.csv')
CIFARTestingFunction(anet, 0.005, 'target-x_BatchTesting_AlexNet_005_CIFAR.csv')
CIFARTestingFunction(anet, 0.001, 'target-x_BatchTesting_AlexNet_001_CIFAR.csv')
CIFARTestingFunction(anet, 0.05, 'target-x_BatchTesting_AlexNet_05_CIFAR.csv')
CIFARTestingFunction(anet, 0.01, 'target-x_BatchTesting_AlexNet_01_CIFAR.csv')
CIFARTestingFunction(anet, 0.1, 'target-x_BatchTesting_AlexNet_1_CIFAR.csv')
CIFARTestingFunction(anet, 0.2, 'target-x_BatchTesting_AlexNet_2_CIFAR.csv')

CIFARTestingFunction(gnet, 0.0005, 'target-x_BatchTesting_GoogleNet_0005_CIFAR.csv')
CIFARTestingFunction(gnet, 0.0001, 'target-x_BatchTesting_GoogleNet_0001_CIFAR.csv')
CIFARTestingFunction(gnet, 0.005, 'target-x_BatchTesting_GoogleNet_005_CIFAR.csv')
CIFARTestingFunction(gnet, 0.001, 'target-x_BatchTesting_GoogleNet_001_CIFAR.csv')
CIFARTestingFunction(gnet, 0.05, 'target-x_BatchTesting_GoogleNet_05_CIFAR.csv')
CIFARTestingFunction(gnet, 0.01, 'target-x_BatchTesting_GoogleNet_01_CIFAR.csv')
CIFARTestingFunction(gnet, 0.1, 'target-x_BatchTesting_GoogleNet_1_CIFAR.csv')
CIFARTestingFunction(gnet, 0.2, 'target-x_BatchTesting_GoogleNet_2_CIFAR.csv')

CIFARTestingFunction(res34, 0.0005, 'target-x_BatchTesting_ResNet34_0005_CIFAR.csv')
CIFARTestingFunction(res34, 0.0001, 'target-x_BatchTesting_ResNet34_0001_CIFAR.csv')
CIFARTestingFunction(res34, 0.005, 'target-x_BatchTesting_ResNet34_005_CIFAR.csv')
CIFARTestingFunction(res34, 0.001, 'target-x_BatchTesting_ResNet34_001_CIFAR.csv')
CIFARTestingFunction(res34, 0.05, 'target-x_BatchTesting_ResNet34_05_CIFAR.csv')
CIFARTestingFunction(res34, 0.01, 'target-x_BatchTesting_ResNet34_01_CIFAR.csv')
CIFARTestingFunction(res34, 0.1, 'target-x_BatchTesting_ResNet34_1_CIFAR.csv')
CIFARTestingFunction(res34, 0.2, 'target-x_BatchTesting_ResNet34_2_CIFAR.csv')
